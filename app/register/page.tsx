      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--muted2)] mt-1">
            Start tracking what you&apos;re saving for.
          </p>
        </div>
        ...
        >
          {error && (
            <div className="mb-4 text-sm text-white bg-[var(--red)]/15 border border-[var(--red)]/30 text-[var(--red)] rounded-lg px-3 py-2">
              {error}
            </div>
          )}
          ...
          <input
            ...
            className="w-full mb-1.5 rounded-lg border border-[var(--border2)] bg-[var(--s2)] px-3 py-2.5 text-[var(--white)] placeholder:text-[var(--muted)] focus:outline-none focus:ring-2 focus:ring-[var(--blue)]"
            placeholder="At least 8 characters"
          />
          <p className="text-xs text-[var(--muted2)] mb-5">Minimum 8 characters.</p>
